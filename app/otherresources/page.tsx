...
export default function OtherResourcesPage() {
    return (
        <main>
            ...
            <head><title>Lim Lim Cubes | Other Resources</title>
  <meta name="description" content="These are some other resources such as videos, articles and different websites that can help you learn different algorithms and expand your cubing knowledge in general" />
